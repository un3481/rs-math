...
const ASIN_2_RE: Decimal = dec!(1.570796326794896619231321691639751);
const ASIN_2_IM: Decimal = dec!(-1.316957896924816708625046347307968);
const ASIN_2: Complex = Complex::new(ASIN_2_RE, ASIN_2_IM);

const ACOS_3I1_RE: Decimal = dec!(0.3377011092655525270851559001076854);
const ACOS_3I1_IM: Decimal = dec!(-1.824198702193882734419662159070223);
const ACOS_3I1: Complex = Complex::new(ACOS_3I1_RE, ACOS_3I1_IM);

const ATAN_1IN3_RE: Decimal = dec!(1.461461853857925638210234816514782);
const ATAN_1IN3_IM: Decimal = dec!(-0.3059438579055289264121938211617347);
...
fn test_complex_trigonometry() -> Result<(), Error> {
    // Set Variables
    let _asin_2_std = ASIN_2.round_dp(STD_DIG);
    let _acos_3i1_std = ACOS_3I1.round_dp(STD_DIG);
